...
df_chronic<- cbind(rbind(month_chronic_0.05, month_chronic_0.25, 
                         month_chronic_0.5, month_chronic_0.75, 
                         month_chronic_0.95), 
                   sort(rep(c(.05, .25, .5, .75, .95), 60)))|>
  filter(quant == 0.5)|>
  select(-quant)
colnames(df_chronic)<- colnames(month_chronic_0.05)
...
plot_i<- ggplot(data = df_chronic, 
    ...
    scale_x_continuous(breaks = 1:12,
                       labels = c("Jan", "Feb", "Mar", "Apr", "May", "Jun", 
                                  "Jul", "Aug", "Sep", "Oct", "Nov", "Dec")) +
    labs(title = "Effects of month on total no. of chronic diseases", x = "month", y = "age") +
    scale_colour_manual(values = c("0.05" = "red", "0.25" = "blue", 
                                   "0.5" = "black", "0.75" = "blue",
                                   "0.95" = "red")) +
    labs(colour = "quantile") +
