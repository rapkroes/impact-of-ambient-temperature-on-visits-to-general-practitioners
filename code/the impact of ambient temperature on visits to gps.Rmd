...
tuning.wrapper<- function(lambda_value, alpha_value){
  elastic.net(inputdf = rhs_Thom_q1, y= full.df_7$age, spline.pos = c(1,85), spline.knots = c(4,5), sel.loss.function = "quantile", sel.quantile = 0.5, alpha = alpha_value, lambda = lambda_value)
} 
