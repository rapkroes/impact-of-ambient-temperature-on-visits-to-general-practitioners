...
# performance eval
perf_TDI<- ga2performance.eval(hyperpars_q2, inputdf = df_qx(di = "TDI", q = 2), 
                    y = full.df_7$diag_class - 1, est.type = "multiclass",
                    cv = 10)
perf_HW<- ga2performance.eval(hyperpars_q2, inputdf = df_qx(di = "HW", q = 2), 
                    y = full.df_7$diag_class - 1, est.type = "multiclass",
                    cv = 10)
perf_SDI<- ga2performance.eval(hyperpars_q2, inputdf = df_qx(di = "SDI", q = 2), 
                    y = full.df_7$diag_class - 1, est.type = "multiclass",
                    cv = 10)
# eval of output
