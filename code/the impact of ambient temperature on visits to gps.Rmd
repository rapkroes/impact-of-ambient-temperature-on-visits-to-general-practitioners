...
```{r}
sus.entry.vec<- suspicious.Diag.entries(icd10vec = Diag1$icd10, no.workers = 4)
diag_sus<- Diag1
diag_sus$class<- icd10.to.class(diag_sus$icd10)
View(diag_sus[sus.entry.vec,])
diag_rm.sus<- Diag1[!sus.entry.vec,]
```
...
full.df_1.1<- add.last.visit(full.df_1, no.splits = 50, no.workers =global.workers)
