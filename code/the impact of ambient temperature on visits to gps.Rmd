...
model.list_1<- list(age = "quantile", gender = "binary", phi = "binary",
                    chronic = "quantile")
...
# performance eval plots. Estimates vs. real values
# eval of output
# make fake dgp great (again)
```
Research question 2:
```{r}
#Hyperparameter tuning
